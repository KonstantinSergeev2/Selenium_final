...
class ProductPage(BasePage):
    ...
    def should_be_correct_product_name(self):
        ...
        success_product_name = self.browser.find_element(*ProductPageLocators.SUCCESS_PRODUCT_NAME).text

        assert product_name == success_product_name, \
            f"Product name in message '{success_product_name}' doesn't match actual product name '{product_name}'"
